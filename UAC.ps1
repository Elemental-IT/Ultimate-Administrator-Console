...
Function get-memorydetails {
   ...
   Clear-Output
   $TextBox_Output.text = Invoke-Expression "wmic memorychip list full" -ErrorAction Stop | Out-String
...
$Button_Memorydetails   = New-Object System.Windows.Forms.Button -Property @{
    Location            = "55,245"
    Size                = "50,37"
    FlatStyle           = "Flat"
}
...
$Button_Memorydetails.FlatAppearance.BorderSize = 0
$Button_WindowServerAction.Image = $Icon_OK
$Button_InstallRsat.Image = [System.IconExtractor]::Extract("Shell32.dll", 71, $true)
$Button_Memorydetails.Image = [System.IconExtractor]::Extract("Shell32.dll", 12, $true)

# ToolTips
$Tooltip_InstallRsat                = New-Object System.Windows.Forms.ToolTip
$Tooltip_Memorydetail               = New-Object System.Windows.Forms.ToolTip
...
$Tooltip_Memorydetail.SetToolTip($Button_Memorydetails , "Get RAM Details")
...
$Button_Memorydetails.add_Click({ get-memorydetails })
...
$GroupBox_Font = New-Object System.Windows.Forms.GroupBox -Property @{
    Location                        = "5,455"
    Size                            = "409, 120"
    Text                            = "Font settings"
}
